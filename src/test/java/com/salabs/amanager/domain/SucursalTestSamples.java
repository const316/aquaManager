...
public class SucursalTestSamples {
    ...
    public static Sucursal getSucursalSample1() {
        return new Sucursal().id(1L).nombre("nombre1").direccion("direccion1").telefono("telefono1");
    }

    public static Sucursal getSucursalSample2() {
        return new Sucursal().id(2L).nombre("nombre2").direccion("direccion2").telefono("telefono2");
    }
