...
import { sampleWithRequiredData } from '../sucursal.test-samples';
...
describe('Sucursal Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to sucursalService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSucursalIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSucursalIdentifier).toHaveBeenCalledWith(entity);
