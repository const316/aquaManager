...
import { sampleWithRequiredData } from '../maestro.test-samples';
import { MaestroService } from '../service/maestro.service';

import { MaestroComponent } from './maestro.component';
import SpyInstance = jest.SpyInstance;

describe('Maestro Management Component', () => {
  let comp: MaestroComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MaestroComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.maestros?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to maestroService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaestroIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaestroIdentifier).toHaveBeenCalledWith(entity);
